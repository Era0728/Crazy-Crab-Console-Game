...
public class Brick extends JComponent{
	...
	public void paintComponent(Graphics g){
		Image Img;
		switch(display){
		case 1:Img=new ImageIcon("D:\\Program Files\\eclipse\\Workspace\\Crazy Crab\\brick3.png").getImage();
			 g.drawImage(Img,x_pos,y_pos,width,height, null);	
			 break;
		case 2:Img=new ImageIcon("D:\\Program Files\\eclipse\\Workspace\\Crazy Crab\\brick2.png").getImage();
		 	 g.drawImage(Img,x_pos,y_pos,width,height, null);	
		 	 break;
		case 3:Img=new ImageIcon("D:\\Program Files\\eclipse\\Workspace\\Crazy Crab\\brick1.png").getImage();
		 	 g.drawImage(Img,x_pos,y_pos,width,height, null);	
		 	 break;
		 default:
		}
